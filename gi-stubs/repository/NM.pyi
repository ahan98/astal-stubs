...
SETTING_BRIDGE_MULTICAST_LAST_MEMBER_INTERVAL = "multicast-last-member-interval"
...
SETTING_BRIDGE_MULTICAST_QUERY_RESPONSE_INTERVAL = "multicast-query-response-interval"
...
SETTING_BRIDGE_MULTICAST_STARTUP_QUERY_INTERVAL = "multicast-startup-query-interval"
...
SETTING_CONNECTION_IP_PING_ADDRESSES_REQUIRE_ALL = "ip-ping-addresses-require-all"
...
SETTING_GSM_INITIAL_EPS_BEARER_PASSWORD_FLAGS = "initial-eps-bearer-password-flags"
...
SETTING_GSM_INITIAL_EPS_BEARER_REFUSE_MSCHAP = "initial-eps-bearer-refuse-mschap"
SETTING_GSM_INITIAL_EPS_BEARER_REFUSE_MSCHAPV2 = "initial-eps-bearer-refuse-mschapv2"
...
SETTING_IP4_CONFIG_DHCP_VENDOR_CLASS_IDENTIFIER = "dhcp-vendor-class-identifier"
...
def ip_routing_rule_from_string(
    str: str | None = None,
    to_string_flags: IPRoutingRuleAsStringFlags | None = None,
    extra_args: GLib.HashTable | None = None,
) -> IPRoutingRule:
    """
...
def keyfile_read(
    keyfile: GLib.KeyFile | None = None,
    base_dir: str | None = None,
    handler_flags: KeyfileHandlerFlags | None = None,
    handler: KeyfileReadHandler = None,
...
def keyfile_write(
    ...
    handler_flags: KeyfileHandlerFlags | None = None,
    handler: KeyfileWriteHandler | None = None,
    user_data: typing.Any | None = None,
) -> GLib.KeyFile:
...
def utils_ap_mode_security_valid(
    type: UtilsSecurityType | None = None,
    wifi_caps: DeviceWifiCapabilities | None = None,
) -> bool:
...
def utils_bin2hexstr(
    src: typing.Any | None = None, len: int | None = None, final_len: int | None = None
) -> str:
...
def utils_check_virtual_device_compatibility(
    virtual_type: GType | None = None, other_type: GType | None = None
) -> bool:
...
def utils_copy_cert_as_user(
    filename: str | None = None, user: str | None = None
) -> str:
...
def utils_enum_from_str(
    type: GType | None = None,
    str: str | None = None,
    out_value: int = None,
    err_token: str | None = None,
) -> bool:
...
def utils_enum_get_values(
    type: GType | None = None, _from: int | None = None, to: int | None = None
) -> typing.Any:
...
def utils_file_is_private_key(
    filename: str | None = None, out_encrypted: bool | None = None
) -> bool:
...
def utils_file_search_in_paths(
    ...
    try_first: str | None = None,
    paths: str | None = None,
    file_test_flags: GLib.FileTest | None = None,
    predicate: UtilsFileSearchInPathsPredicate | None = None,
    user_data: typing.Any | None = None,
) -> str:
...
def utils_format_variant_attributes(
    attributes: GLib.HashTable | None = None,
    attr_separator: str | None = None,
...
def utils_hwaddr_aton(
    asc: str | None = None, buffer: typing.Any | None = None, length: int | None = None
) -> int:
...
def utils_hwaddr_matches(
    hwaddr1: typing.Any | None = None,
    hwaddr1_len: gssize | None = None,
    hwaddr2: typing.Any | None = None,
    hwaddr2_len: gssize | None = None,
) -> bool:
...
def utils_ip4_addresses_from_variant(
    value: GLib.Variant | None = None, out_gateway: str | None = None
) -> typing.Any:
...
def utils_ip4_addresses_to_variant(
    addresses: typing.Any | None = None, gateway: str = None
) -> GLib.Variant:
...
def utils_ip_addresses_from_variant(
    value: GLib.Variant | None = None, family: int | None = None
) -> typing.Any:
...
def utils_ip_routes_from_variant(
    value: GLib.Variant | None = None, family: int | None = None
) -> typing.Any:
    """Utility function to convert a #GVariant representing a list of new-style
    NetworkManager IPv4 or IPv6 addresses (as described in the documentation for
...
def utils_parse_variant_attributes(
    ...
    attr_separator: str = None,
    key_value_separator: str | None = None,
    ignore_unknown: bool | None = None,
    spec: VariantAttributeSpec | None = None,
) -> GLib.HashTable:
...
def utils_same_ssid(
    ssid1: typing.Any | None = None,
    len1: int | None = None,
    ssid2: typing.Any | None = None,
    len2: int | None = None,
    ignore_trailing_null: bool | None = None,
) -> bool:
...
def utils_security_valid(
    type: UtilsSecurityType | None = None,
    wifi_caps: DeviceWifiCapabilities | None = None,
    have_ap: bool | None = None,
    adhoc: bool | None = None,
    ap_flags: NM80211ApFlags | None = None,
    ap_wpa: NM80211ApSecurityFlags | None = None,
    ap_rsn: NM80211ApSecurityFlags | None = None,
) -> bool:
    """Given a set of device capabilities, and a desired security type to check
...
def utils_sriov_vf_to_str(
    vf: SriovVF | None = None, omit_index: bool | None = None
) -> str:
...
def utils_wep_key_valid(
    key: str | None = None, wep_type: WepKeyType | None = None
) -> bool:
...
def utils_wifi_channel_to_freq(
    channel: int | None = None, band: str | None = None
) -> int:
...
def utils_wifi_find_next_channel(
    channel: int | None = None, direction: int | None = None, band: str | None = None
) -> int:
...
def utils_wifi_is_channel_valid(
    channel: int | None = None, band: str | None = None
) -> bool:
...
def vpn_editor_plugin_load(
    plugin_name: str | None = None, check_service: str | None = None
) -> VpnEditorPlugin:
...
def vpn_editor_plugin_load_from_file(
    ...
    check_owner: int | None = None,
    check_file: UtilsCheckFilePredicate = None,
    user_data: typing.Any | None = None,
) -> VpnEditorPlugin:
    """Load the shared library @plugin_name and create a new
    #NMVpnEditorPlugin instance via the #NMVpnEditorPluginFactory
...
class BridgeVlan:
    ...
    def __init__(
        self, vid_start: int | None = None, vid_end: int | None = None
    ) -> None:
...
class Client(GObject.Object, Gio.AsyncInitable, Gio.Initable):
    ...
    def activate_connection_finish(
        self, result: Gio.AsyncResult | None = None
    ) -> ActiveConnection:
    ...
    def add_and_activate_connection2_finish(
        self, result: Gio.AsyncResult = None, out_result: GLib.Variant | None = None
    ) -> ActiveConnection:
    ...
    def add_connection2(
        self,
        settings: GLib.Variant | None = None,
        flags: SettingsAddConnection2Flags | None = None,
        args: GLib.Variant | None = None,
        ignore_out_result: bool | None = None,
        cancellable: Gio.Cancellable | None = None,
        callback: Gio.AsyncReadyCallback | None = None,
        user_data: typing.Any | None = None,
    ) -> None:
    ...
    def add_connection2_finish(
        self,
        result: Gio.AsyncResult | None = None,
        out_result: GLib.Variant | None = None,
    ) -> RemoteConnection:
        """
    ...
    def checkpoint_create(
        self,
        devices: typing.Any | None = None,
        rollback_timeout: int | None = None,
        flags: CheckpointCreateFlags | None = None,
        cancellable: Gio.Cancellable | None = None,
        callback: Gio.AsyncReadyCallback | None = None,
        user_data: typing.Any | None = None,
    ) -> None:
    ...
    def checkpoint_rollback_finish(
        self, result: Gio.AsyncResult | None = None
    ) -> GLib.HashTable:
    ...
    def deactivate_connection(
        self,
        active: ActiveConnection | None = None,
        cancellable: Gio.Cancellable | None = None,
    ) -> bool:
    ...
    def deactivate_connection_finish(
        self, result: Gio.AsyncResult | None = None
    ) -> bool:
    ...
    def get_permission_result(
        self, permission: ClientPermission | None = None
    ...
    def load_connections(
        self,
        filenames: typing.Any | None = None,
        failures: str = None,
        cancellable: Gio.Cancellable | None = None,
    ) -> bool:
    ...
    def load_connections_finish(
        self, failures: typing.Any | None = None, result: Gio.AsyncResult | None = None
    ) -> bool:
    ...
    def reload(
        self,
        flags: ManagerReloadFlags | None = None,
        cancellable: Gio.Cancellable | None = None,
        callback: Gio.AsyncReadyCallback | None = None,
        user_data: typing.Any | None = None,
    ) -> None:
    ...
    def wait_shutdown(
        self,
        integrate_maincontext: bool | None = None,
        cancellable: Gio.Cancellable | None = None,
        callback: Gio.AsyncReadyCallback | None = None,
        user_data: typing.Any | None = None,
    ) -> None:
...
class Connection:
    ...
    def clear_secrets_with_flags(
        self,
        func: SettingClearSecretsWithFlagsFn = None,
        user_data: typing.Any | None = None,
    ) -> None:
    ...
    def compare(
        self, b: Connection | None = None, flags: SettingCompareFlags | None = None
    ) -> bool:
    ...
    def diff(
        self,
        b: Connection | None = None,
        flags: SettingCompareFlags | None = None,
        out_settings: GLib.HashTable | None = None,
    ) -> bool:
        """Compares two #NMConnection objects for similarity, with comparison behavior
        modified by a set of flags.  See nm_setting_compare() for a description of
    ...
    def for_each_setting_value(
        self,
        func: SettingValueIterFn | None = None,
        user_data: typing.Any | None = None,
    ) -> None:
    ...
    def normalize(
        self, parameters: GLib.HashTable | None = None, modified: bool | None = None
    ) -> bool:
    ...
    def replace_settings_from_connection(
        self, new_connection: Connection | None = None
    ) -> None:
    ...
    def to_dbus(
        self, flags: ConnectionSerializationFlags | None = None
    ) -> GLib.Variant:
    ...
    def update_secrets(
        self, setting_name: str | None = None, secrets: GLib.Variant | None = None
    ) -> bool:
...
class IPAddress:
    ...
    @staticmethod
    def new(
        family: int | None = None, addr: str | None = None, prefix: int | None = None
    ) -> IPAddress:
        """Creates a new #NMIPAddress object.
    ...
    def cmp_full(
        self, b: IPAddress | None = None, cmp_flags: IPAddressCmpFlags | None = None
    ) -> int:
    ...
    def set_attribute(
        self, name: str | None = None, value: GLib.Variant | None = None
    ) -> None:
...
class IPRoute:
    ...
    def new_binary(
        family: int | None = None,
        dest: typing.Any | None = None,
        prefix: int = None,
        next_hop: typing.Any | None = None,
        metric: int | None = None,
    ) -> IPRoute:
    ...
    def equal_full(
        self, other: IPRoute | None = None, cmp_flags: int | None = None
    ) -> bool:
        """Determines if two #NMIPRoute objects contain the same destination, prefix,
        next hop, and metric.
...
class IPRoutingRule:
    ...
    def get_uid_range(
        self, out_range_start: int | None = None, out_range_end: int | None = None
    ) -> bool:
        """
    ...
    def set_suppress_prefixlength(
        self, suppress_prefixlength: int | None = None
    ) -> None:
        """
    ...
    def set_uid_range(
        self, uid_range_start: int | None = None, uid_range_end: int | None = None
    ) -> None:
...
class KeyfileHandlerData:
    ...
    def get_context(
        self,
        out_kf_group_name: str | None = None,
        out_kf_key_name: str = None,
        out_cur_setting: Setting | None = None,
        out_cur_property_name: str | None = None,
    ) -> None:
    ...
    def warn_get(
        ...
        out_severity: KeyfileWarnSeverity | None = None,
    ) -> None:
        """
...
class LldpNeighbor:
    ...
    def get_attr_string_value(
        self, name: str | None = None, out_value: str | None = None
    ) -> bool:
    ...
    def get_attr_uint_value(
        self, name: str | None = None, out_value: int | None = None
    ) -> bool:
...
class RemoteConnection(Object, Connection):
    ...
    def update2(
        self,
        settings: GLib.Variant | None = None,
        flags: SettingsUpdate2Flags | None = None,
        args: GLib.Variant | None = None,
        cancellable: Gio.Cancellable | None = None,
        callback: Gio.AsyncReadyCallback | None = None,
        user_data: typing.Any | None = None,
...
class SecretAgentOld(GObject.Object, Gio.AsyncInitable, Gio.Initable):
    ...
    def cancel_get_secrets(
        self, connection_path: str | None = None, setting_name: str | None = None
    ) -> None:
        """
    ...
    def delete_secrets(
        ...
        callback: SecretAgentOldDeleteSecretsFunc | None = None,
        user_data: typing.Any | None = None,
    ) -> None:
    ...
    def get_secrets(
        ...
        setting_name: str | None = None,
        hints: typing.Any | None = None,
        flags: SecretAgentGetSecretsFlags | None = None,
        callback: SecretAgentOldGetSecretsFunc | None = None,
        user_data: typing.Any | None = None,
    ) -> None:
    ...
    def save_secrets(
        ...
        connection: Connection | None = None,
        connection_path: str | None = None,
        callback: SecretAgentOldSaveSecretsFunc | None = None,
        user_data: typing.Any | None = None,
    ) -> None:
    ...
    def get_secrets(
        ...
        hints: typing.Any | None = None,
        flags: SecretAgentGetSecretsFlags = None,
        callback: SecretAgentOldGetSecretsFunc | None = None,
        user_data: typing.Any | None = None,
    ) -> None:
        """Asynchronously retrieves secrets belonging to @connection for the
...
class Setting(GObject.Object):
    ...
    @staticmethod
    def get_enum_property_type(
        setting_type: GType | None = None, property_name: str = None
    ) -> GType:
    ...
    def compare(
        self, b: Setting | None = None, flags: SettingCompareFlags | None = None
    ) -> bool:
    ...
    def diff(
        ...
        b: Setting | None = None,
        flags: SettingCompareFlags | None = None,
        invert_results: bool | None = None,
        results: GLib.HashTable | None = None,
    ) -> bool:
        """Compares two #NMSetting objects for similarity, with comparison behavior
        modified by a set of flags.  See the documentation for #NMSettingCompareFlags
    ...
    def get_secret_flags(
        ...
        out_flags: SettingSecretFlags | None = None,
    ) -> bool:
    ...
    def option_get_boolean(
        self, opt_name: str | None = None, out_value: bool | None = None
    ) -> bool:
        """
    ...
    def option_get_uint32(
        self, opt_name: str | None = None, out_value: int | None = None
    ) -> bool:
        """
    ...
    def option_set(
        self, opt_name: str | None = None, variant: GLib.Variant | None = None
    ) -> None:
    ...
    def option_set_boolean(
        self, opt_name: str | None = None, value: bool | None = None
    ) -> None:
    ...
    def option_set_uint32(
        self, opt_name: str | None = None, value: int | None = None
    ) -> None:
    ...
    def set_secret_flags(
        self, secret_name: str | None = None, flags: SettingSecretFlags | None = None
    ) -> bool:
...
class Setting8021x(Setting):
    ...
    @staticmethod
    def check_cert_scheme(
        pdata: typing.Any | None = None, length: int | None = None
    ...
    def add_phase2_altsubject_match(
        self, phase2_altsubject_match: str | None = None
    ) -> bool:
    ...
    def remove_altsubject_match_by_value(
        self, altsubject_match: str | None = None
    ) -> bool:
    ...
    def set_ca_cert(
        self,
        value: str | None = None,
        scheme: Setting8021xCKScheme = None,
        out_format: Setting8021xCKFormat | None = None,
    ) -> bool:
    ...
    def set_phase2_ca_cert(
        self,
        value: str | None = None,
        scheme: Setting8021xCKScheme | None = None,
        out_format: Setting8021xCKFormat | None = None,
    ) -> bool:
    ...
    def set_phase2_private_key(
        ...
        scheme: Setting8021xCKScheme | None = None,
        out_format: Setting8021xCKFormat = None,
    ) -> bool:
        """Private keys are used to authenticate the connecting client to the network
        when EAP-TLS is used as either the "phase 1" or "phase 2" 802.1x
        authentication method.
...
class SettingDcb(Setting):
    ...
    def set_priority_bandwidth(
        self, user_priority: int | None = None, bandwidth_percent: int | None = None
    ) -> None:
    ...
    def set_priority_flow_control(
        self, user_priority: int | None = None, enabled: bool | None = None
    ) -> None:
    ...
    def set_priority_group_bandwidth(
        self, group_id: int | None = None, bandwidth_percent: int | None = None
    ) -> None:
        """These values are only valid when #NMSettingDcb:priority-group-flags includes
        the %NM_SETTING_DCB_FLAG_ENABLE flag.
    ...
    def set_priority_group_id(
        self, user_priority: int | None = None, group_id: int | None = None
    ) -> None:
        """These values are only valid when #NMSettingDcb:priority-group-flags includes
        the %NM_SETTING_DCB_FLAG_ENABLE flag.
    ...
    def set_priority_strict_bandwidth(
        self, user_priority: int | None = None, strict: bool | None = None
    ) -> None:
        """These values are only valid when #NMSettingDcb:priority-group-flags includes
        the %NM_SETTING_DCB_FLAG_ENABLE flag.
    ...
    def set_priority_traffic_class(
        self, user_priority: int | None = None, traffic_class: int | None = None
    ) -> None:
        """
...
class SettingEthtool(Setting):
    ...
    def set_feature(
        self, optname: str | None = None, value: Ternary | None = None
    ) -> None:
...
class SettingMatch(Setting):
    ...
    def remove_kernel_command_line_by_value(
        self, kernel_command_line: str | None = None
    ) -> bool:
...
class SettingTeam(Setting):
    ...
    def remove_link_watcher_by_value(
        self, link_watcher: TeamLinkWatcher | None = None
    ) -> bool:
...
class SettingVlan(Setting):
    ...
    def add_priority_str(
        self, map: VlanPriorityMap | None = None, str: str | None = None
    ) -> bool:
    ...
    def remove_priority(
        self, map: VlanPriorityMap | None = None, idx: int | None = None
    ) -> None:
    ...
    def remove_priority_str_by_value(
        self, map: VlanPriorityMap | None = None, str: str | None = None
    ) -> bool:
...
class SettingVpn(Setting):
    ...
    def foreach_data_item(
        self, func: VpnIterFunc | None = None, user_data: typing.Any | None = None
    ) -> None:
...
class SettingWireGuard(Setting):
    ...
    def get_peer_by_public_key(
        self, public_key: str | None = None, out_idx: int | None = None
    ) -> WireGuardPeer:
        """
    ...
    def set_peer(
        self, peer: WireGuardPeer | None = None, idx: int | None = None
    ) -> None:
...
class SettingWireless(Setting):
    ...
    def ap_security_compatible(
        self,
        s_wireless_sec: SettingWirelessSecurity | None = None,
        ap_flags: NM80211ApFlags | None = None,
        ap_wpa: NM80211ApSecurityFlags | None = None,
        ap_rsn: NM80211ApSecurityFlags | None = None,
        ap_mode: NM80211Mode | None = None,
    ) -> bool:
...
class SriovVF:
    ...
    def set_vlan_protocol(
        self, vlan_id: int | None = None, protocol: SriovVFVlanProtocol | None = None
    ) -> None:
...
class TeamLinkWatcher:
    ...
    @staticmethod
    def new_arp_ping(
        init_wait: int | None = None,
        interval: int | None = None,
        missed_max: int | None = None,
        target_host: str | None = None,
        source_host: str | None = None,
        flags: TeamLinkWatcherArpPingFlags | None = None,
    ) -> TeamLinkWatcher:
    ...
    @staticmethod
    def new_ethtool(
        delay_up: int | None = None, delay_down: int | None = None
    ) -> TeamLinkWatcher:
...
class VpnEditorPlugin:
    ...
    def load_from_file(
        ...
        check_service: str | None = None,
        check_owner: int | None = None,
        check_file: UtilsCheckFilePredicate | None = None,
        user_data: typing.Any | None = None,
    ) -> VpnEditorPlugin:
        """Load the shared library @plugin_name and create a new
        #NMVpnEditorPlugin instance via the #NMVpnEditorPluginFactory
    ...
    def export_to_file(
        self, path: str | None = None, connection: Connection | None = None
    ) -> bool:
    ...
    def get_vt(
        self, vt: VpnEditorPluginVT | None = None, vt_size: int | None = None
    ) -> int:
...
class VpnPluginInfo(GObject.Object, Gio.Initable):
    ...
    @staticmethod
    def new_with_data(
        filename: str | None = None, keyfile: GLib.KeyFile | None = None
    ) -> VpnPluginInfo:
    ...
    @staticmethod
    def list_add(
        list: GLib.SList | None = None, plugin_info: VpnPluginInfo | None = None
    ) -> bool:
        """
    ...
    def list_find_by_filename(
        list: GLib.SList | None = None, filename: str | None = None
    ) -> VpnPluginInfo:
        """
    ...
    @staticmethod
    def list_find_by_name(
        list: GLib.SList | None = None, name: str | None = None
    ) -> VpnPluginInfo:
        """
    ...
    def list_find_by_service(
        list: GLib.SList | None = None, service: str | None = None
    ) -> VpnPluginInfo:
        """
    ...
    def list_get_service_types(
        list: GLib.SList | None = None,
        only_existing: bool = None,
        with_abbreviations: bool | None = None,
    ) -> typing.Any:
        """
...
class VpnPluginOld(GObject.Object, Gio.Initable):
    ...
    def read_vpn_details(
        fd: int | None = None,
        out_data: GLib.HashTable | None = None,
        out_secrets: GLib.HashTable | None = None,
    ) -> bool:
    ...
    def connect_interactive(
        self, connection: Connection | None = None, details: GLib.Variant | None = None
    ) -> bool:
        """
    ...
    def need_secrets(
        self, connection: Connection | None = None, setting_name: str | None = None
    ) -> bool:
        """
    ...
    def secrets_required(
        self, message: str | None = None, hints: str | None = None
    ) -> None:
...
class WireGuardPeer:
    ...
    def append_allowed_ip(
        self, allowed_ip: str | None = None, accept_invalid: bool | None = None
    ) -> bool:
    ...
    def cmp(
        self, b: WireGuardPeer | None = None, compare_flags: SettingCompareFlags = None
    ) -> int:
        """
    ...
    def get_allowed_ip(
        self, idx: int | None = None, out_is_valid: bool | None = None
    ) -> str:
        """
    ...
    def is_valid(
        self, check_non_secrets: bool | None = None, check_secrets: bool | None = None
    ) -> bool:
        """
    ...
    def set_endpoint(
        self, endpoint: str | None = None, allow_invalid: bool | None = None
    ) -> bool:
    ...
    def set_preshared_key(
        self, preshared_key: str | None = None, accept_invalid: bool | None = None
    ) -> bool:
    ...
    def set_preshared_key_flags(
        self, preshared_key_flags: SettingSecretFlags | None = None
    ) -> None:
        """It is a bug trying to modify a sealed #NMWireGuardPeer instance.
    ...
    def set_public_key(
        self, public_key: str | None = None, accept_invalid: bool | None = None
    ) -> bool:
...
class Device(Object):
    ...
    def disambiguate_names(
        devices: typing.Any | None = None, num_devices: int | None = None
    ) -> typing.Any:
    ...
    def get_applied_connection_finish(
        self, result: Gio.AsyncResult | None = None, version_id: int | None = None
    ) -> Connection:
